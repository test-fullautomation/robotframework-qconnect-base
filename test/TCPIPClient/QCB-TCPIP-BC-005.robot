...
QCB-TCPIP-BC-005
    ...
    should_match_regexp    ${result}    The connection type 'INVALID_CONNECTION_TYPE' is not supported. Please choose one of: (DLT, DLTConnector, GoepelClient, )?RabbitmqClient, SSHClient, SerialClient, TCPIPClient, TCPIPServer, Winapp\.$
