...
QCB-TCPIP-GC-053
    [Documentation]    Fetch block (4)
    ...                No filter pattern defined, search pattern defined (with two capturing groups).
    ...
    set_test_variable    ${connection_name}    QCB-TCPIP-GC-053-Connection
    ...
    log    TCPIP-GC-053 'verify' status: ${status}    console=yes
    log    TCPIP-GC-053 'verify' result: ${result}    console=yes
