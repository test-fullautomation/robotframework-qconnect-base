...
\subsubsection*{Example: Verifying service startup logs with \rcode{fetch\_block}}
...
\subsubsection{Example: Filtering service startup logs with \rcode{fetch\_block} and \rcode{filter\_pattern}}
