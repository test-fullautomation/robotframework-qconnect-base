...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "./../QConnectBase")))

# print("(debug) sys.path:\n" + '\n'.join(sys.path))

# -- Project information -----------------------------------------------------

project = 'The QConnection Base Library'
copyright = '2021, Nguyen Huynh Tri Cuong (RBVH/ECM1)'
...
latex_documents = [('index', 'QConnectBase.tex', project, author, 'manual', False)]
